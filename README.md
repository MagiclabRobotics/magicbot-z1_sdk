...
> For more user guide, please go to [Qucik Start](https://support.magiclab.top/docs/human-z1/quick_start_reference)
...
```
  ...
  mkdir build
  cd build
  cmake .. -DCMAKE_PREFIX_PATH=/opt/magic_robotics/magicbot_z1_sdk
  make -j8
```
